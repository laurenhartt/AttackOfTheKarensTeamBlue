...
//      int nearestKarenCol = 999;
//     int nearestKarenRow = 999;
//      int curXDif = 0;
//      int curYDif = 0;
//      foreach (Store s in stores) {
//        if (s.karen.IsPresent) {
//         int kCol = s.karen.Col;
//          int kRow = s.karen.Row;
//          int xDif = xOwner - kCol;
//          int yDif = yOwner - kRow;
//          int AbsXDif = Math.Abs(xDif);
//          int AbsYDif = Math.Abs(yDif);
//          if (AbsXDif < nearestKarenCol) {
//            curXDif = xDif;
//            nearestKarenCol = AbsXDif;
//          }
//          if (AbsYDif < nearestKarenRow) {
//            curYDif = yDif;
//            nearestKarenRow = AbsYDif;
//          }
//        }
//      }
//      if (curXDif < 0) {
